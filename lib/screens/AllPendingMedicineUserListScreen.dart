...
class _AllPendingMedicineUserListScreenState extends State<AllPendingMedicineUserListScreen> {
  ...
  RxList<WithoutDescriptionAppointment> filteredList = RxList<WithoutDescriptionAppointment>();
  ...
  void initState() {
    ...
    handleRefresh();
    filteredList.addAll(mainController.pendingAppointmentWithoutDescriptionList);
  ...
  void _filterAppointments() {
    ...
    if (query.isEmpty) {
      filteredList.assignAll(mainController.pendingAppointmentWithoutDescriptionList);
    } else {
      filteredList.assignAll(mainController.pendingAppointmentWithoutDescriptionList.where((appointment) {
          ...
          children: [
            ...
            Expanded(
              child: RefreshIndicator(
                ...
                elevation: 3,
                child: Obx(() {
                  final appointments = filteredList; // mainController.withoutDescriptionAppointmentResponse.value?.data;
