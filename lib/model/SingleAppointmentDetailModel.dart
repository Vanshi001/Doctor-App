...
class SingleAppointmentDetailModelWithoutCallHistory {
  final bool success;
  final AppointmentDetailDataWithoutCallHistory? data;

  SingleAppointmentDetailModelWithoutCallHistory({
    required this.success,
    required this.data,
  });

  factory SingleAppointmentDetailModelWithoutCallHistory.fromJson(Map<String, dynamic> json) {
    return SingleAppointmentDetailModelWithoutCallHistory(
      success: json['success'] as bool,
      data: AppointmentDetailDataWithoutCallHistory.fromJson(json['data'] as Map<String, dynamic>),
    );
  }
...
class AppointmentDetailDataWithoutCallHistory {
  final TimeSlot? timeSlot;
  final String? id;
  final String? customerId;
  // final String? profilePicture;
  ...
  AppointmentDetailDataWithoutCallHistory({
  ...
  factory AppointmentDetailDataWithoutCallHistory.fromJson(Map<String, dynamic> json) {
    return AppointmentDetailDataWithoutCallHistory(
