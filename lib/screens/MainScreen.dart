                      ...
                      Row(
                        children: [
                          ...
                          Builder(
                            builder:
                                (context) => IconButton(
                                  icon: Image.asset("assets/ic_menu.png", width: 24, height: 24),
                                  onPressed: () {
                                    Scaffold.of(context).openDrawer(); // Opens the drawer
                                  },
                                ),
                          ),
                          Expanded(child: Text("Dermatics India", style: TextStyles.textStyle2_4, textAlign: TextAlign.center)),
                          Obx(
                            () => Container(
                              height: 30,
                              width: 30,
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: ColorCodes.white, width: 2),
                              ),
                      ...
                      Padding(
                        ...
                        child: Obx(
                          () => Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Hello', style: TextStyles.textStyle1_1),
                              Text(
