...
class _AppointmentsScreenState extends State<AppointmentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: true, // allow the screen to pop normally
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) {
          // Reset your filter tab to All
          controller.selectedTab.value = TabType.all;
          controller.updateTab(TabType.all, widget.doctorId);
